...
public class JFileManager implements FileManager, Serializable {
   ...
   *
   * @param previous_history the previous history
 ...
 * @throws NonvalidArgumentException 
   */
  public boolean checkPathToFile(String path, Directory currentDir) throws NonvalidArgumentException {
