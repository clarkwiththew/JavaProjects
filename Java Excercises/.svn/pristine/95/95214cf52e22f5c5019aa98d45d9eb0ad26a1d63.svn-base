...
public class Lab5Driver {
  ...
  public static void main(String[] argv) {
	  ...
	  Motorcycle motorcycle2 = (Motorcycle) moped2 ;
	  
	  // TODO: for moped2, set engine size to 5, wheels to 2, speed to 50
	  //
	  //
	  moped2.setEngineSize(5);
